$(document).ready(function () {
    ...
    database.ref().on("child_changed", function (snapshot) {
        ...
        // currentTableRow.append(trainTableUpdate(snapshot));//this doesn't work as it tries to append another row inside of the empty row.
    });
    ...
    $("#tableBody").on("click", ".edit", function () { //this button uses the 'edit-mode' attribute of the <tr>'s as a duel-function switch
        ...
        if (($("#train" + currentTrain).attr('edit-mode')) == 'false') {
            ...
            if (!newFirst) {
                console.log("set newFirst to oldFIrst")
                newFirst = oldFirst;
            }
